...
Repeated labels require equal occurrence counts and a unique counterpart with
an overlapping ink band. When several candidates share that band, exactly one
must also overlap horizontally. Unequal counts and remaining ambiguities stay
findings. Partially joined cells are
